...
1. حدد **تكوين & إرسال** في أعلى الصفحة لفتح حوار **مهمة إعداد البنية** الأساسية لبرنامج ربط العمليات التجارية.
...
1. انتظر بضع دقائق حتى تنتهي عملية التشغيل. يمكنك التحقق من حالة المهمة عن طريق تحديد **الوظائف** ضمن **الأصول**. من هناك، حدد مهمة **تدريب السعر التلقائي** .
...
1. عند اكتمال تشغيل التجربة، انقر بزر الماوس الأيمن فوق الوحدة النمطية **تقييم النموذج** وحدد **معاينة البيانات** ثم **تقييم النتائج**.
...
1. قم بتوصيل الإخراج من الوحدة النمطية **Score Model** بإدخال **Dataset1** (الأكثر يسارا) من **Execute Python Script**.
