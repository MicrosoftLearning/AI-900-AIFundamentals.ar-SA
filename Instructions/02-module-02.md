...
1. حدد **+ إنشاء مورد**، وابحث عن *التعلم الآلي*، وأنشئ موردا جديدا **للتعلم الآلي من Azure** بالإعدادات التالية:
...
1. في استوديو التعلم الآلي من Microsoft Azure، انقر فوق **إدارة ميزات المعاينة** (أيقونة مكبر الصوت الصاخبة - &#128363;).
...
1. إنشاء مهمة التعلم الآلي التلقائي الجديدة باستخدام الإعدادات التالية، باستخدام **التالي** كما هو مطلوب للتقدم من خلال واجهة المستخدم:

    **الإعدادات الأساسية**:

    - **اسم الوظيفة**: mslearn-bike-automl
    - ⁧**⁩اسم التجربة الجديدة⁧**⁩: mslearn-bike-rental
    - **الوصف**: التعلم الآلي التلقائي للتنبؤ بتأجير الدراجات
    - **العلامات**: *لا شيء*
   ...
   **نوع المهمة & البيانات**:
    ...
    **إعدادات المهمة**:
    ...
    - **إعدادات التكوين الإضافية**:
        - **المقياس الأساسي**: متوسط الخطأ التربيعي للجذر الذي تمت تسويته
    ...
    - **الحدود**: *توسيع هذا القسم*
        ...
        - **الحد الأقصى للعقد**: 3
        - **حد درجة المقياس**: 0.85 (*بحيث إذا حقق النموذج درجة مقياس خطأ تربيعية متوسط الجذر الطبيعي تبلغ 0.085 أو أقل، تنتهي المهمة.*)
        - **المهلة**: 15
        - **مهلة التكرار**: 5
