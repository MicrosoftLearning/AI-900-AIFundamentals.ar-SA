...
توفر خدمة *Azure الذكاء الاصطناعي Vision* نماذج مفيدة تم إنشاؤها مسبقا للعمل مع الصور، ولكنك ستحتاج غالبا إلى تدريب النموذج الخاص بك على رؤية الكمبيوتر. على سبيل المثال، افترض أن منظمة الحفاظ على الحياة البرية تريد تتبع مشاهد الحيوانات باستخدام كاميرات حساسة للحركة. ويمكن بعد ذلك استخدام الصور التي تلتقطها الكاميرات للتحقق من وجود أنواع معينة في منطقة معينة والمساعدة في جهود حفظ الأنواع المهددة بالانقراض. ولتحقيق ذلك، ستستفيد المنظمة من نموذج *تصنيف الصور* المدرب على تحديد أنواع مختلفة من الحيوانات في الصور الفوتوغرافية الملتقطة.

في Azure، يمكنك استخدام خدمة ***Custom Vision*** لتدريب نموذج تصنيف الصور استنادا إلى الصور الموجودة. هناك عنصران لإنشاء حل تصنيف الصور. أولاً، يجب تدريب نموذج للتعرف على الفئات المختلفة باستخدام الصور الموجودة. بعد ذلك، عندما يتم تدريب النموذج، يجب عليك نشره كخدمة يمكن أن تستهلكها التطبيقات.
...
>**ملاحظة** لا يتوفر كل مورد في كل منطقة. سواء قمت بإنشاء Custom Vision أو مورد خدمات Azure الذكاء الاصطناعي، يمكن استخدام الموارد التي تم إنشاؤها في [مناطق معينة](https://azure.microsoft.com/global-infrastructure/services/?products=cognitive-services) فقط للوصول إلى خدمات Custom Vision. من أجل البساطة، يتم تحديد المنطقة مسبقاً لك في إرشادات التكوين أدناه.
...
1. في مدخل Custom Vision، أنشئ مشروعًا جديدًا بالإعدادات التالية:
    ...
    - **المورد**: *خدمات Azure الذكاء الاصطناعي أو مورد Custom Vision الذي قمت بإنشائه مسبقا*
...
1. انقر فوق **&#128504; Publish** لنشر النموذج المدربين مع الإعدادات التالية:
    ...
    - **مورد التنبؤ**: *خدمات Azure الذكاء الاصطناعي أو مورد توقع الرؤية المخصصة الذي أنشأته مسبقا*.
...
1. تحقق من أن النموذج يصنف هذه الصورة **كأسد**.
