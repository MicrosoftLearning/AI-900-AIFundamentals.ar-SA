...
1. انقر فوق **تقديم‏‎**. ثم في أعلى الصفحة انقر فوق **Save changes**. قد تحتاج إلى تغيير حجم نافذتك لرؤية الزر.
...
1. في أعلى الصفحة، اضغط على **نشر**. سيسألك مربع حوار عما إذا كنت تريد نشر المشروع. حدد **نشر**.
...
1. أنشئ بوت لتطبيق ويب في مدخل Microsoft Azure. (قد ترى رسالة تحذير للتحقق من أن مصدر القالب موثوق به. لا تحتاج إلى اتخاذ أي إجراء لهذه الرسالة.) تابع عن طريق تحديث الإعدادات التالية:
    ...
    - **معرَّف تطبيق Microsoft**
        - **نوع الإنشاء**: *حدد إنشاء هوية مُدارة جديدة مُعينة من قبل المستخدم* 

5. حدد **التالي: تطبيق الويب >** للاستمرار في تحديث الإعدادات. 
    - **خدمة التطبيق**
    ...
    - **إعدادات التطبيق**
        ...
        > **ملاحظة** للانتقال إلى مفتاح مورد اللغة، افتح [https://portal.azure.com](https://portal.azure.com?azure-portal=true). في الصفحة الرئيسية، انقر فوق *مجموعات الموارد* وحدد موقع مجموعة الموارد التي أنشأت مورد اللغة فيها. حدد مورد اللغة وانتقل إلى قائمته اليسرى. ثم حدد *المفاتيح ونقاط النهاية*. انسخ أحد المفاتيح. 
