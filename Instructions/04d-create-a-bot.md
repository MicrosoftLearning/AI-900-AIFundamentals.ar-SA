...
1. في الصفحة **Create Language**، حدد الإعدادات التالية:
    ...
    > **ملاحظة** إذا قمت بالفعل بتوفير مورد Azure Cognitive Search** من المستوى **المجاني، فقد لا تسمح لك الحصة النسبية بإنشاء مورد آخر. وفي هذه الحالة، حدد مستوى آخر غير **Free F**.
...
1. في أعلى الصفحة، انقر فوق **نشر**. سيسألك مربع حوار عما إذا كنت تريد نشر المشروع. حدد **نشر**.
...
1. في مدخل Microsoft Azure، أنشئ Web App Bot. (قد ترى رسالة تحذير للتحقق من أن مصدر القالب موثوق به. لا تحتاج إلى اتخاذ أي إجراء لهذه الرسالة.) تابع عن طريق تحديث الإعدادات التالية:
    ...
    - **تفاصيل المثيل**
        - **موقع** مجموعة الموارد: *نفس موقع خدمة* Language.
    - **Azure Bot**
...
5. حدد **Next: Web App >** لمتابعة تحديث الإعدادات. 
    ...
    - **إعدادات التطبيق**
        ...
        > **ملاحظة** للانتقال إلى مفتاح مورد اللغة، افتح [https://portal.azure.com](https://portal.azure.com?azure-portal=true). في الصفحة الرئيسية، انقر فوق *مجموعات* الموارد وحدد موقع مجموعة الموارد التي أنشأت مورد اللغة فيها. حدد مورد اللغة وانتقل إلى القائمة اليسرى الخاصة به. ثم حدد *المفاتيح ونقطة* النهاية. انسخ أحد المفاتيح. 
