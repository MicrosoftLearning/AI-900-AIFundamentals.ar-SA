...
1. حدد **مشاريع كائن ثنائي كبير الحجم في Azure: مستند**. سيظهر إعداد *Container name* مع حاوية *knowledge-store* التي تمت تعبئتها تلقائياً. لا تقم بتغيير اسم الحاوية.
