...
- **مورد خدمات** Azure الذكاء الاصطناعي، والذي يوفر خدمات الذكاء الاصطناعي للمهارات التي يمكن أن يستخدمها حل البحث الخاص بك لإثراء البيانات في مصدر البيانات مع الرؤى التي تم إنشاؤها الذكاء الاصطناعي.

    > **ملاحظة** يجب أن تكون موارد خدمات Azure Cognitive Search وAzure الذكاء الاصطناعي في نفس الموقع!
...
1. حدد **Review + create**، وبعد مشاهدة الاستجابة **Validation Success**، حدد **Create**.
...
ستحتاج إلى توفير **مورد خدمات** Azure الذكاء الاصطناعي في نفس موقع مورد Azure Cognitive Search. سيستخدم حل البحث الخاص بك هذا المورد لإثراء البيانات الموجودة في مخزن البيانات بالرؤى التي تم إنشاؤها بواسطة الذكاء الاصطناعي.

1. ارجع إلى الصفحة الرئيسية لمدخل Azure. **انقر فوق &65291; أنشئ زر مورد** وابحث عن *خدمات* Azure الذكاء الاصطناعي. حدد **إنشاء** **خطة خدمات** الذكاء الاصطناعي Azure. سيتم نقلك إلى صفحة لإنشاء مورد خدمات Azure الذكاء الاصطناعي. قم بتكوينه بالإعدادات التالية:
    - **الاشتراك**: *اشتراك Azure الخاص بك*.
...
1. في حساب Azure Storage الذي أنشأته، في جزء القائمة الأيسر، حدد **Configuration** (ضمن **الإعدادات**).
1. قم بتغيير الإعداد الخاص ب *Allow Blob anonymous access* to **Enabled** ثم حدد **Save**.
...
1. ضمن **Save Enrichments to a Knowledge Store**، حدد:
    ...
    > 1. انقر فوق **+ Container** لإنشاء حاوية جديدة تسمى **مخزن المعرفة** مع تعيين مستوى الخصوصية إلى **خاص**، وحدد **إنشاء**.
